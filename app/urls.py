...
urlpatterns = [
    ...
    path('save_days', views.save_days, name="save_days"),
    ...
    path('tractor/<slug:data>/', views.tractor, name='tractordata'),
    path('engine/', views.engine, name='engine'),
    path('engine/<slug:data>/', views.engine, name='enginedata'),
    path('gardeningtool/', views.gardeningtool, name='gardeningtool'),
    path('gardeningtool/<slug:data>/', views.gardeningtool, name='gardeningtooldata'),
    path('farmingtool/', views.farmingtool, name='farmingtool'),
    path('farmingtool/<slug:data>/', views.farmingtool, name='farmingtooldata'),
